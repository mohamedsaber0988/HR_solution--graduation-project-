...
const LeaveRequestModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (formData.sick_pdf) {
                data.append('sick_pdf', formData.sick_pdf);
            }
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    {formData.leave_type === 'sick' && (
                        <div className="space-y-1.5 animate-in slide-in-from-top-2 duration-200">
                            <label className="text-sm font-semibold text-gray-700">Medical Report (PDF/Image)</label>
                            <input 
                                type="file" 
                                accept=".pdf,image/*"
                                onChange={(e) => setFormData({...formData, sick_pdf: e.target.files[0]})}
